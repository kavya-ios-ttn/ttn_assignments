...
extension ViewController: CLLocationManagerDelegate {
    func locationManager(_ manager: CLLocationManager, didUpdateLocations locations: [CLLocation]) {
        ...
        let coordinateRegion = MKCoordinateRegion(center: currentLocation, latitudinalMeters: 100, longitudinalMeters: 100)
        mapView.setRegion(coordinateRegion, animated: true)
        
        let circle = MKCircle(center: jaipurAnnotation, radius: 100000)
        mapView.addOverlay(circle)
        let circle1 = MKCircle(center: dehradunAnnotation, radius: 100)
